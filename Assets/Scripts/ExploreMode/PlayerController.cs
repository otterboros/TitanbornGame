...
// From Starter Assets First Person Controller
/// <summary>
/// Passes input controls into player object.
/// Handles movement, sprinting, look rotation, jumping, and object selection.
/// </summary>
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _input = GetComponent<ExploreModeInputs>();
#if ENABLE_INPUT_SYSTEM && STARTER_ASSETS_PACKAGES_CHECKED
